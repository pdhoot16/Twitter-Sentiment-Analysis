...
shinyServer(function(input, output, session) {
  ...
  consumer_key <- "WvNpotc6eh8DqBVtTEnn0sJCP" # consumer key
  consumer_secret <- "QVirXZ7mjsqbjRDGJQwStPi1gqg4liAszxf4MzJ1ZJD78eQLim" # consumer secret
  access_token <- "3320439044-XjeZMo2obmV2Ov3uenwmUPeQZIdCTDdtgcYyHt4" # access token
  access_secret <- "jCbubowG7I7IjODWhTo7OWcI8G2FJBzNoIoSbqAE0EYTy" # access secret
  ...
  pos.words = scan('D:\\Data Mining\\Assignment\\CA2\\positive_words.txt', what='character', comment.char=';') #Provide your path to "positive_words.txt" file
  neg.words = scan('D:\\Data Mining\\Assignment\\CA2\\negative_words.txt', what='character', comment.char=';') #Provide your path to "negative_words.txt" file
